...
export const sampleQuestions: QuestionType[] = [
  ...
  // Ek örnek sorular - Fen Bilimleri
  {
    ...
    correctAnswer: 'C',
    explanation:
      "İvme, kuvvetin kütleye bölümüne eşittir. Newton'un ikinci yasasına göre F = m*a formülünden a = F/m olarak hesaplanır.",
    subject: 'Fen Bilimleri',
    topic: 'Dinamik',
  ...
  },
  {
    ...
    options: ['Sodyum', 'Potasyum', 'Lityum', 'Sezyum'],
    correctAnswer: 'D',
    explanation:
      'Sezyum periyodik tabloda en aktif metaldir ve en düşük iyonlaşma enerjisine sahiptir.',
    subject: 'Fen Bilimleri',
    topic: 'Periyodik Tablo',
    topicId: 'tyt-kimya-madde',
    difficulty: 2,
  ...
  },
  {
    ...
    correctAnswer: 'B',
    explanation:
      'Hücre zarı fosfolipid çift tabakasından oluşur ve bu yapı hücrenin temel koruyucu bariyeridir.',
    subject: 'Fen Bilimleri',
    topic: 'Hücre',
  ...
  },
  {
    ...
    options: ['Kitap', 'Kalem', 'Telefon', 'Masa'],
    correctAnswer: 'C',
    explanation:
      "'Telefon' kelimesi büyük ünlü uyumuna uymaz çünkü 'e' ve 'o' sesleri aynı kelimede bulunur.",
    subject: 'Türkçe',
    topic: 'Dilbilgisi',
  ...
  },
  {
    ...
    correctAnswer: 'D',
    explanation:
      "'Güzel bir gün, değil mi.' cümlesinde soru işareti kullanılmalıdır.",
    subject: 'Türkçe',
    topic: 'Noktalama',
  ...
  },
  {
    ...
    correctAnswer: 'C',
    explanation:
      "Bir zarın 6 yüzü vardır ve her yüzün gelme olasılığı 1/6'dır.",
    subject: 'Matematik',
    topic: 'Olasılık',
  ...
  {
    questionText:
      'Aşağıdakilerden hangisi mantık biliminin konularından biri değildir?',
    options: ['Önermeler', 'Çıkarımlar', 'Kimyasal tepkimeler', 'Kavramlar'],
    correctAnswer: 'C',
    explanation:
      'Kimyasal tepkimeler kimya biliminin konusudur, mantık biliminin değil.',
    subject: 'Sosyal Bilimler',
    topic: 'Mantık',
