...
export const TOPIC_CATEGORIES: TopicCategory[] = [
  // TYT - Türkçe
  { id: 'tyt-turkce-paragraf', name: 'Paragraf', subject: 'Türkçe', examType: 'TYT' },
  { id: 'tyt-turkce-dilbilgisi', name: 'Dilbilgisi', subject: 'Türkçe', examType: 'TYT' },
  { id: 'tyt-turkce-yazim', name: 'Yazım Kuralları', subject: 'Türkçe', examType: 'TYT' },
  { id: 'tyt-turkce-noktalama', name: 'Noktalama', subject: 'Türkçe', examType: 'TYT' },
  { id: 'tyt-turkce-anlatim', name: 'Anlatım Bozuklukları', subject: 'Türkçe', examType: 'TYT' },

  // TYT - Matematik
  { id: 'tyt-matematik-temel', name: 'Temel Matematik', subject: 'Matematik', examType: 'TYT' },
  { id: 'tyt-matematik-geometri', name: 'Geometri', subject: 'Matematik', examType: 'TYT' },
  { id: 'tyt-matematik-problemler', name: 'Problemler', subject: 'Matematik', examType: 'TYT' },
  { id: 'tyt-matematik-sayilar', name: 'Sayılar', subject: 'Matematik', examType: 'TYT' },
  { id: 'tyt-matematik-olasilik', name: 'Olasılık', subject: 'Matematik', examType: 'TYT' },

  // TYT - Fen Bilimleri
  { id: 'tyt-fizik-mekanik', name: 'Mekanik', subject: 'Fen Bilimleri', examType: 'TYT' },
  { id: 'tyt-fizik-elektrik', name: 'Elektrik', subject: 'Fen Bilimleri', examType: 'TYT' },
  { id: 'tyt-kimya-madde', name: 'Madde ve Özellikleri', subject: 'Fen Bilimleri', examType: 'TYT' },
  { id: 'tyt-kimya-karisma', name: 'Karışımlar', subject: 'Fen Bilimleri', examType: 'TYT' },
  { id: 'tyt-biyoloji-hucre', name: 'Hücre', subject: 'Fen Bilimleri', examType: 'TYT' },
  { id: 'tyt-biyoloji-sistemler', name: 'Sistemler', subject: 'Fen Bilimleri', examType: 'TYT' },

  // TYT - Sosyal Bilimler
  { id: 'tyt-tarih-osmanli', name: 'Osmanlı Tarihi', subject: 'Sosyal Bilimler', examType: 'TYT' },
  { id: 'tyt-tarih-cumhuriyet', name: 'Cumhuriyet Tarihi', subject: 'Sosyal Bilimler', examType: 'TYT' },
  { id: 'tyt-cografya-fiziki', name: 'Fiziki Coğrafya', subject: 'Sosyal Bilimler', examType: 'TYT' },
  { id: 'tyt-cografya-beşeri', name: 'Beşeri Coğrafya', subject: 'Sosyal Bilimler', examType: 'TYT' },
  { id: 'tyt-felsefe-mantik', name: 'Mantık', subject: 'Sosyal Bilimler', examType: 'TYT' },
  { id: 'tyt-felsefe-psikoloji', name: 'Psikoloji', subject: 'Sosyal Bilimler', examType: 'TYT' },

  // AYT - Matematik
  { id: 'ayt-matematik-fonksiyonlar', name: 'Fonksiyonlar', subject: 'Matematik', examType: 'AYT' },
  { id: 'ayt-matematik-turev', name: 'Türev', subject: 'Matematik', examType: 'AYT' },
  { id: 'ayt-matematik-integral', name: 'İntegral', subject: 'Matematik', examType: 'AYT' },
  { id: 'ayt-matematik-trigonometri', name: 'Trigonometri', subject: 'Matematik', examType: 'AYT' },
  { id: 'ayt-matematik-logaritma', name: 'Logaritma', subject: 'Matematik', examType: 'AYT' },

  // AYT - Fen Bilimleri
  { id: 'ayt-fizik-dalgalar', name: 'Dalgalar', subject: 'Fen Bilimleri', examType: 'AYT' },
  { id: 'ayt-fizik-optik', name: 'Optik', subject: 'Fen Bilimleri', examType: 'AYT' },
  { id: 'ayt-fizik-modern', name: 'Modern Fizik', subject: 'Fen Bilimleri', examType: 'AYT' },
  { id: 'ayt-kimya-organik', name: 'Organik Kimya', subject: 'Fen Bilimleri', examType: 'AYT' },
  { id: 'ayt-kimya-analitik', name: 'Analitik Kimya', subject: 'Fen Bilimleri', examType: 'AYT' },
  { id: 'ayt-biyoloji-genetik', name: 'Genetik', subject: 'Fen Bilimleri', examType: 'AYT' },
  { id: 'ayt-biyoloji-evrim', name: 'Evrim', subject: 'Fen Bilimleri', examType: 'AYT' },

  // AYT - Sosyal Bilimler
  { id: 'ayt-tarih-inkilap', name: 'İnkılap Tarihi', subject: 'Sosyal Bilimler', examType: 'AYT' },
  { id: 'ayt-tarih-cagdas', name: 'Çağdaş Türk Tarihi', subject: 'Sosyal Bilimler', examType: 'AYT' },
  { id: 'ayt-cografya-ekonomik', name: 'Ekonomik Coğrafya', subject: 'Sosyal Bilimler', examType: 'AYT' },
  { id: 'ayt-cografya-cevre', name: 'Çevre Coğrafyası', subject: 'Sosyal Bilimler', examType: 'AYT' },
  { id: 'ayt-felsefe-etik', name: 'Etik', subject: 'Sosyal Bilimler', examType: 'AYT' },
  { id: 'ayt-felsefe-sosyoloji', name: 'Sosyoloji', subject: 'Sosyal Bilimler', examType: 'AYT' },

  // YDT - İngilizce
  { id: 'ydt-ingilizce-dilbilgisi', name: 'Dilbilgisi', subject: 'İngilizce', examType: 'YDT' },
  { id: 'ydt-ingilizce-kelime', name: 'Kelime Bilgisi', subject: 'İngilizce', examType: 'YDT' },
  { id: 'ydt-ingilizce-paragraf', name: 'Paragraf', subject: 'İngilizce', examType: 'YDT' },
  { id: 'ydt-ingilizce-diyalog', name: 'Diyalog', subject: 'İngilizce', examType: 'YDT' },
  { id: 'ydt-ingilizce-cumle', name: 'Cümle Tamamlama', subject: 'İngilizce', examType: 'YDT' },
];
...
export class QuestionService {
  ...
  static async saveUserSelections(selections: UserSelections): Promise<void> {
    try {
      await AsyncStorage.setItem(this.USER_SELECTIONS_KEY, JSON.stringify(selections));
    } catch (error) {
  ...
  static async getUserSelections(): Promise<UserSelections | null> {
    try {
      const selectionsData = await AsyncStorage.getItem(this.USER_SELECTIONS_KEY);
  ...
  static async getRandomQuestionsBySelections(count: number): Promise<QuestionType[]> {
    try {
      ...
      console.error('Seçimlere göre rastgele sorular getirilirken hata:', error);
      return [];
    }
  }
